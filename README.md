[![Docker Image](https://img.shields.io/badge/docker%20image-available-green.svg)](https://hub.docker.com/r/flaviopontes/svn-manager/)
...
```
docker run -d --name svn-server -p 80:80 -p 3690:3690 flaviopontes/svn-manager
```
